                ...
                <div id="undefined-footer">
                  <div class="col-sm-6">
                        <ul class="pagination " style="font-weight:bold!important;">
                          ...
                          <div class="infos" style="color: black"><p align="right"><span adr_trans="label_showing">Showing</span><?php  if(($start_no_users+1)<0){ echo "0";}else{ echo $start_no_users+1;}?><span adr_trans="label_to">to</span><?php if($cnt<0){ echo "0";}else{ echo $cnt;}?><span adr_trans="">of</span><?php echo $total_no; ?><span adr_trans="label_entries">entries</span></p></div>
                            <br>  <br>
                          </div>
