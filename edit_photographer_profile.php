  ...
  <div class="col-md-6">
        ...
        <input id="profile_pic" name="profile_pic" placeholder="Profile picture" type="file" autocomplete="off" class="form-control form-value" >
									...
									<div class="col-md-12">
										...
										<br>
															  <p align="right" >
																<button class="AnimationBtn ActionBtn-sm" type="submit" name="profilebtn" id="label_update_profile" adr_trans="label_update_profile"><i class="fa fa-sign-in" adr_trans="label_update_profile"></i>Update Profile</button>
																					&nbsp;&nbsp;<a class="AnimationBtn CancelBtn-sm" href="photographer_profile.php" id="label_cancel" adr_trans="label_cancel" adr_trans="label_cancel"><i class="fa fa-times"></i>Cancel</a></p>
