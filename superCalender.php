...
<?php include "header.php";  ?>
 <div class="section-empty bgimage3">
	...
	<?php include "csr_sidebar"; ?>
				...
				<a href="create_order.php" class="AnimationBtn ActionBtn-sm" id="label_create_new_order" adr_trans="label_create_new_order"><i class="fa fa-calendar"></i> Create New Order</a>
				</h5>
