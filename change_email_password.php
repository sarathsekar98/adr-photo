...
<?php include "header.php";  ?>
 <div class="section-empty bgimage5">
	...
	<?php include "sidebar.php"; ?>
                ...
                <div class="col-md-10">
<h5 adr_trans="label_settings">Settings</h5>
...
<?php if(@isset($_REQUEST["eu"])) { ?>
						...
						<?php }  ?>
<tr><td style="padding-left:20px!important;"><h5 adr_trans="label_first_name">First Name</h5></td><td><?php echo $user1['first_name']; ?><br /></td></tr>
<tr><td style="padding-left:20px!important;"><h5 adr_trans="label_last_name">Last  Name</h5></td><td>  <?php echo $user1['last_name']; ?><br /></td></tr>
<tr><td style="padding-left:20px!important;"><h5 adr_trans="label_organization">Organization</h5></td><td>  <?php if($_SESSION['user_type']!='Photographer') {echo $user1['organization_name'];} else { echo $organization_name; } ?><td align="left">
<?php if($_SESSION['user_type']!='Photographer'){?><a href="#changePersonal" id="uname" class="lightbox link  ActionBtn-sm" data-lightbox-anima="show-scale" style="font-size:13px;text-decoration:none;color:blue;" adr_trans="label_update">Update</a></td></td></tr><?php } ?>


<tr><td style="padding-left:20px!important;"><h5>Role </h5></td><td> <?php echo $user1['type_of_user']; ?><br /></td><td align="left">
...
<tr><td style="padding-left:20px!important;"><h5 adr_trans="label_user_name">User Name </h5></td><td> <?php echo $user1['email']; ?><br /></td><td><a href="#changeemail" id="uname1" class="lightbox link ActionBtn-sm" data-lightbox-anima="show-scale" style="font-size:13px;text-decoration:none;color:blue;" adr_trans="label_update">Update</a><br /></td></tr>
<tr><td style="padding-left:20px!important;padding-bottom:20px;"><h5 adr_trans="label_new_password">Password</h5></td><td>
 ...
 <br /></td><td><a href="#changePassword" class="lightbox link ActionBtn-sm" data-lightbox-anima="show-scale" id="upass" style="font-size:13px;text-decoration:none;color:blue;" adr_trans="label_update">Update</a><br /></td></tr>
...
<div id="changePersonal" class="box-lightbox white" style="color: #000;background: #FFF;padding:25px;height:300px; width:500px;border-radius:10px">
	...
	<tr><td adr_trans="label_organization">Organization</td><td>:</td><td><input type="text" name="org" class="form-control" required value="<?php echo $user1['organization_name']; ?>" /></td></tr>
				...
				<input type="submit" name="changeprofile" value="Update Profile" class="btn btn-primary ActionBtn-sm" style="border-radius:20px 20px 20px 20px;background:#0275D8" /></td></tr>
				</form>
...
<div id="changePassword" class="box-lightbox white" style="color: #000;background: #FFF;padding:25px;height:300px; width:500px;border-radius:10px">
				...
				<tr><td colspan="3" align="center">
				<input type="submit" name="changepass" value="Update Password" class="btn btn-primary ActionBtn-sm" style="border-radius:20px 20px 20px 20px;background:#0275D8" /></td></tr>
				</form>
				...
				<tr><td>&nbsp;</td><td>&nbsp;</td><td><input type="submit" name="sendcode" value="Send Verification Code" class="btn btn-warning CancelBtn-sm" style="border-radius:20px 20px 20px 20px; background:#F0AD4E" /></td></tr>
				</form>
				...
				<tr><td>&nbsp;</td><td>&nbsp;</td><td><input type="submit" name="updateemail" value="Update Email" class="btn btn-primary ActionBtn-sm" style="border-radius:20px 20px 20px 20px; background:#0275D8" />
