...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function renderInnerContent(innerProps) {
		...
		if(innerProps.event.title==0)
		{
		 return (createElement("div", { className: "fc-event-main-frame status"+innerProps.event.extendedProps.status+" gmailEvent"+innerProps.event.extendedProps.address+" status"+innerProps.event.extendedProps.status },
            innerProps.timeText && (createElement("div", { className: "fc-event-time status"+innerProps.event.extendedProps.status }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title-container" })));
		}
		else
		{
			
			if(innerProps.event.extendedProps.gmailEvent==1)
			{
			return (createElement("div", { className: "fc-event-main-frame  status"+innerProps.event.extendedProps.status },
            innerProps.timeText && (createElement("div", { className: "fc-event-time status"+innerProps.event.extendedProps.status }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title-container" },
                 createElement("div", { className: "fc-event-title fc-sticky status"+innerProps.event.extendedProps.status },''+innerProps.event.extendedProps.address || createElement(Fragment, null, "\u00A0"),createElement("a", {style:"float:right;color:#006600",href: "sss.com",innerText:"Google"})))));
				
			}
			else if(innerProps.event.extendedProps.gmailEvent!=1 && innerProps.event.extendedProps.status=='BUSY')
			{
				 return (createElement("div", { className: "fc-event-main-frame  status"+innerProps.event.extendedProps.status },
            innerProps.timeText && (createElement("div", { className: "fc-event-time status"+innerProps.event.extendedProps.status }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title-container" },
                createElement("div", { className: "fc-event-title fc-sticky status"+innerProps.event.extendedProps.status },''+innerProps.event.extendedProps.address || createElement(Fragment, null, "\u00A0"),createElement("a", { OnClick:"removeBusy("+innerProps.event.extendedProps.orderId+")",style:"float:right;color:red",href: "sss.com",className:"busyIcon",innerHTML:"<i class='fa fa-trash'></a>"})))));
			}
			else
			{
        return (createElement("div", { className: "fc-event-main-frame  status"+innerProps.event.extendedProps.status },
            innerProps.timeText && (createElement("div", { className: "fc-event-time status"+innerProps.event.extendedProps.status }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title-container" },
                createElement("div", { className: "fc-event-title fc-sticky status"+innerProps.event.extendedProps.status }, ''+innerProps.event.extendedProps.address || createElement(Fragment, null, "\u00A0")))));
    ...
    */
    ...
    function renderInnerContent$2(innerProps) {
        ...
        return (createElement(Fragment, null,
            createElement("div", { className: "fc-daygrid-event-dot status"+innerProps.event.extendedProps.status, style: { borderColor: innerProps.borderColor || innerProps.backgroundColor } }),
            innerProps.timeText && (createElement("div", { className: "fc-event-time status"+innerProps.event.extendedProps.status }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title gmailEvent"+innerProps.event.address+" status"+innerProps.event.extendedProps.status }, ' Gmail event' || createElement(Fragment, null, "\u00A0"))));
		}
		else
		{
			  return (createElement(Fragment, null,
            createElement("div", { className: "fc-daygrid-event-dot status"+innerProps.event.extendedProps.status, style: { borderColor: innerProps.borderColor || innerProps.backgroundColor } }),
            innerProps.timeText && (createElement("div", { className: "fc-event-time status"+innerProps.event.extendedProps.status }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title status"+innerProps.event.extendedProps.status }, ''+innerProps.event.extendedProps.address || createElement(Fragment, null, "\u00A0"))));
		}
    }
