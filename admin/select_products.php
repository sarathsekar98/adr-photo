...
var $changeInputs = $('input.sTotal');
    $changeInputs.each(function(idx, el) {
	  ...
	  $("#totalValue").html(TotalValueis);
		...
		<a href="#" id="thirdStep" class="NonActiveBreadcrum"><i class="fa fa-database" style="font-size:30px;color:#000;padding-top:10px;"></i>
			<span class="breadcrumb__inner">
		...
		<a href="#" id="thirdStep" class="btn ActionBtn-sm">
			<span class="breadcrumb__inner">
				<span class="breadcrumb__title" id="label_products" adr_trans="label_products">Products</span>
